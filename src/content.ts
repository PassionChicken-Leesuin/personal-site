 ...
 * 홈 화면의 소개.
 *
 * 문단 단위로 나눠 둔다. 한 문자열로 이어 붙이면 자바스크립트에서는 사이의
 * 빈 줄이 사라져 화면에 글자 벽 하나로 떨어진다.
 */
export const about = [
  "현재 서울대학교 산업공학과 석사과정 DDSI Lab에서 연구하고 있습니다. " +
    "에이전틱 AI를 활용한 암묵지 외재화, 멀티에이전트 토론 시스템 기반 유망기술 예측, " +
    "도메인 유효특허 선별 시스템 개발, 그리고 서지계량·텍스트 지표를 결합한 유망기술 " +
    "예측을 주요 연구 주제로 다루고 있습니다.",
  "대외 협력 연구로는 한국지식재산연구원과 함께 상표와 특허 IPC를 연계하는 알고리즘을 " +
    "구축하고, 산업거래 데이터를 바탕으로 특허의 경제적 효과를 산출하는 방법론을 " +
    "개발하고 있습니다. 동시에 KT 통신국사의 냉방 제어 AI 실증 데이터를 분석하고 있으며, " +
    "국내 대기업 대상 에이전틱 AI 개발 교육과 기술 멘토링에도 참여하고 있습니다.",
];
...
export const site = {
  ...
  /** 메타·OG 설명용 한 문단. 화면에 나오는 것은 about 이다. */
  tagline: about[0],
...
export const journey: Chapter[] = [
  ...
  },
  {
    ...
    body:
      "데이터 분석 TF 연구원. 기지국 HVAC의 AI 냉방 제어를 검증합니다.",
  },
  {
    period: "2025 — 2026",
    title: "연구실과 강의실 사이",
